package com.dalmirdasilva.arduinoorientationgameapp;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener bindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                System.out.println("ListPreference, index: " + index);
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || ConnectFragment.class.getName().equals(fragmentName)
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ConnectFragment extends PreferenceFragment {
